                ...
                <div className={style.box}>
                    <div className={style.boxContent}>
                        ...
                        <div className={style.boxContentRight}>
                            ...
                            <span className={this.state.phone?style.llctitle2:style.llctitle1}>
                                忘记密码<a className={style.llctitleA} onClick={this.phem.bind(this)} href="javascript:void (0)">{this.state.phone?'使用邮箱找回':'使用手机找回'} &nbsp;></a>
                                </span>
                                ...
                                <div hidden={!this.state.phone}>
                                    <Form onSubmit={this.handleSubmit}>
                                        <div className={style.perselphone}>
                                            ...
                                            <FormItem>
                                                <Button htmlType="submit" style={{width: '100%', height: 48, marginTop: 10,fontSize:16,backgroundColor:'rgba(217,186,131,1)',color:'#fff'}}>{"确认修改密码,并重新登录"}</Button>
                                            </FormItem>
                                        </div>
                                    </Form>
                                </div>
