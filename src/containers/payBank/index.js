                                ...
                                <div className={style.wlopMContentR}>
                                    ...
                                    <span className={style.inpTip}>
                                        开户行
                                                        ...
                                                        {getFieldDecorator('bank', {
                                                            rules: [{ required: true, message: '请输入您的开户行！',pattern: /^[\u4E00-\u9FA5A-Za-z]+$/}]
                                                        })(
                                                            <Input  className={style.inputp} placeholder="请输入开户行" />
                                                        )}
                                                    </FormItem>
                                                    </div>
                                                    <div className={style.inp}>
                                    <span className={style.inpTip}>
                                        开户支行
                                                        ...
                                                        {getFieldDecorator('bankZhi', {
                                                            rules: [{ required: true, message: '请输入您的开户支行！',pattern: /^[\u4E00-\u9FA5A-Za-z]+$/ }]
                                                            })(
                                                            <Input  className={style.inputp} placeholder="请输入开户支行" />
                                                        )}
                                                    </FormItem>
                                                    </div>
                                                    <div className={style.inp}>
                                    <span className={style.inpTip}>
                                        银行卡号
                                                        ...
                                                        {getFieldDecorator('bankAccount', {
                                                            rules: [{ required: true, message: '请输入您的银行卡号！',pattern: /^[0-9]*$/, }]
                                                        })(
                                                            <Input  className={style.inputp} placeholder="请输入银行卡号" />
                                                        )}
                                                    </FormItem>
                                                    </div>
